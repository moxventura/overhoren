    ...
    <div class="install-container">
        ...
        <div class="content">
            ...
            <?php elseif ($step == 2): ?>
                ...
                <div class="info-box">
                    <h3>📊 Wat wordt geïnstalleerd?</h3>
                    <p>• Database tabellen (tests, questions, admin_users)<br>
                    • Optioneel: Nederlandse voorbeelddata (5 toetsen met 25 vragen)</p>
                </div>
            ...
            <?php elseif ($step == 4): ?>
                ...
                <div class="success-page">
                    ...
                    <p>Overhoren is succesvol geïnstalleerd en klaar voor gebruik.</p>
                    
                    <div class="info-box">
                        <h3>🎉 Wat kun je nu doen?</h3>
                        <p>• <strong>Beheerpaneel:</strong> Beheer toetsen en vragen<br>
                        • <strong>Hoofdsite:</strong> Bekijk beschikbare toetsen<br>
                        • <strong>Inloggen:</strong> Gebruik je admin credentials</p>
                    </div>
