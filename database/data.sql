-- Sample data for Overhoren application
-- This file contains the initial test data and sample admin user
...
-- Note: Admin user creation is now handled by the setup process
-- No default admin user is inserted here to maintain security
